// import()
// 前面介绍过，import命令会被 JavaScript 引擎静态分析，
// 先于模块内的其他语句执行（import命令叫做“连接” binding 其实更合适）。所以，下面的代码会报错。
...
import("./myModule.js").then(myModual => {
  console.log(myModual.default);
});
...
async function main() {
  const myModual = await import('./myModule.js');
