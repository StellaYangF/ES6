...
// 不过，这种写法很难查错，建议凡是输入的变量，都当作【完全只读】，轻易不要改变它的属性。

// import后面的from指定模块文件的位置，可以是相对路径，
// 也可以是绝对路径，.js后缀可以省略。如果只是模块名，不带有路径，
...
// 上面的代码不会报错，因为import的执行早于foo的调用。这种行为的本质是，import命令是【编译阶段执行的，在代码运行之前】。
